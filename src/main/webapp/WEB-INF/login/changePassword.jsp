...
<head>
	...
	<link rel="stylesheet" href="/swan_stream/styles/login/change_password.css">
                            ...
                            <div class="css-s08p0c">
                                <button aria-label="accountAndSettings" type="button" class="css-1tjvop5">
                                        <figure class="css-1uyohez">
                                            <img alt="" src="/swan_stream/images/profile_image.jpg" class="css-o65cdz">
                                        </figure>
                                </button>
                            </div>
                        </div>
        ...
        <footer class=" css-hubf7r">
            ...
            <div class="css-1ia10w4">
                <a href="https://team.watcha.com">
                    ...
                    <!-- -->Copyright © <!-- -->2022<!-- --> by <em>SwanStream, Inc.</em> <!-- -->All rights reserved.
            </div>
        </footer>
    </div>
...
$('#password').focusout(function(){
	...
	if($('#password').val() == ''){
		...
		$.ajax({
			type: 'post',
			url: '/swan_stream/isExistPassword',
...
$('#change-password-btn').click(function(){
	...
	if($('#newPassword').val() == ''){
		...
		$.ajax({
			type: 'post',
			url: '/swan_stream/changeNewPassword',
...
$(function(){
	$('#change-password-btn').click(function(){
		$.ajax({
		    type: 'post',
		    url: '/swan_stream/changePassword',
